...
public class HttpClientUtils {
	...
	public static Map<String, Object> getInputStreamByUrl(String url) throws Exception {
		return getInputStreamByUrl(url, connTimeout, readTimeout);
	}
	 ...
	 * @throws Exception
	 */
	public static Map<String, Object> getInputStreamByUrl(String url, Integer connTimeout, Integer readTimeout)
			throws ConnectTimeoutException, SocketTimeoutException, Exception {
		...
		map.put("get", get);
		map.put("stream", result);
		map.put("client", client);
		
		long end = System.currentTimeMillis();
		log.debug("getInputStreamByUrl use time:" + (end-start) + " ms,url:" + url);
	...
	public static void main(String[] args) {
		try {
			...
			// "UTF-8", 10000, 10000);
			String str = get("https://www.elsiglodetorreon.com.mx/finanzas/", "UTF-8");
			/*
