...
public class ElasticSearchUtil {
	...
	static {
		...
		try {
			String eshostports = PropertyContentLoader.getValues(FallbackConstant.ES_HOST_PORT);
			String[] hostports = eshostports.split(",");
			Settings settings = Settings.builder()
					.put("cluster.name", PropertyContentLoader.getValues(FallbackConstant.ES_CLUTER_NAME))
	...
	public SearchResponse search(String[] indexs,String[] types,ESQCondition eSQCondition,String[] fields){
		...
		logger.info("Es Query:" + searchRequestBuilder.toString());
