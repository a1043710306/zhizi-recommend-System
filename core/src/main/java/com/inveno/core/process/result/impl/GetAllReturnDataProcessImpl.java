...
@Component("getAllReturnDataProcessImpl")
public class GetAllReturnDataProcessImpl extends AbstractReturnDataProcess {
...
//			}
	...
	public static void main(String[] args) {
		try {
		GetAllReturnDataProcessImpl ga = new GetAllReturnDataProcessImpl();
