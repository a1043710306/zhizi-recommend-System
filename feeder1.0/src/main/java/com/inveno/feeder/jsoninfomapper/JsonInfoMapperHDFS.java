...
public class JsonInfoMapperHDFS implements RowMapper<Map<String, String>>
{
	@Override
	...
	public List<Map<String, String>> mapIntoFeederInfoList(List<Map<String, Object>> info_map_list, Map<String, EditorTableEntry> mEntry)
	{
		...
		for (Map<String, Object> info_map : info_map_list)
		{
			...
			jsonMap.put("md5", (String)info_map.get("md5"));
			jsonMap.put("simhash", (String)info_map.get("simhash"));
			...
			jsonMap.put("list_images_count", String.valueOf((Integer)info_map.get("list_images_count")));
			jsonMap.put("body_images_count", String.valueOf((Integer)info_map.get("body_images_count")));
			jsonMap.put("word_count", (String)info_map.get("word_count"));
			jsonMap.put("group_id", (String)info_map.get("group_id"));
			jsonMap.put("update_time", info_map.get("update_time").toString());
			...
			jsonMap.put("author", (String)info_map.get("author"));
			jsonMap.put("country", (String)info_map.get("country"));
			jsonMap.put("discoveryTime", info_map.get("discovery_time").toString());
			jsonMap.put("fetchTime", info_map.get("fetch_time").toString());
			jsonMap.put("sourceItemId", (String)info_map.get("source_item_id"));
			jsonMap.put("link", (String)info_map.get("link"));
			jsonMap.put("title", (String)info_map.get("title"));
			jsonMap.put("content", (String)info_map.get("content"));
			jsonMap.put("summary", (String)info_map.get("summary"));
			jsonMap.put("copyright", (String)info_map.get("copyright"));
			jsonMap.put("hasCopyright", String.valueOf(info_map.get("has_copyright")));
			jsonMap.put("bodyImages", (String)info_map.get("body_images"));
			jsonMap.put("listImages", (String)info_map.get("list_images"));
			jsonMap.put("publisherPagerankScore", String.valueOf((Double)info_map.get("publisher_pagerank_score")));
			jsonMap.put("sourceCommentCount", String.valueOf(info_map.get("source_comment_count")));
			jsonMap.put("fallImage", (String)info_map.get("fall_image"));
			jsonMap.put("displayListImages", (String)info_map.get("display_list_images"));
			jsonMap.put("isOpenComment", String.valueOf((Integer)info_map.get("is_open_comment")));
